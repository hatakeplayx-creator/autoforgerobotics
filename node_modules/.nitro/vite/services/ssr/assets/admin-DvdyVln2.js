import { r as apiFetch, t as useAuth } from "./useAuth-BDG16QbY.js";
import { t as cn } from "./utils-C_uf36nf.js";
import { t as Toaster$1 } from "./sonner-DoFKumIW.js";
import * as React from "react";
import { useCallback, useEffect, useRef, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { toast } from "sonner";
import { Box, Boxes, FileImage, Home, LayoutDashboard, LogOut, Menu, Package, Search, Settings, ShoppingBag, Users, X } from "lucide-react";
import * as DialogPrimitive from "@radix-ui/react-dialog";
//#region src/services/adminApi.ts
...
//#endregion
//#region src/routes/admin/components/DashboardSection.tsx
var statusStyle = {
...
function SkeletonCard() {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", { className: "mt-3 h-8 w-32 animate-pulse rounded bg-muted" }),
			/* @__PURE__ */ jsx("div", { className: "mt-3 h-3 w-28 animate-pulse rounded bg-muted" })
		]
	});
}
	...
	if (loading) return /* @__PURE__ */ jsxs(Fragment, { children: [
		...
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", { className: "h-5 w-40 animate-pulse rounded bg-muted" }), /* @__PURE__ */ jsx("div", {
					className: "mt-8 flex h-48 items-end gap-2",
					children: Array.from({ length: 10 }).map((_, i) => /* @__PURE__ */ jsx("div", {
				...
				className: "rounded-lg border bg-card p-5",
				children: [/* @__PURE__ */ jsx("div", { className: "h-5 w-36 animate-pulse rounded bg-muted" }), /* @__PURE__ */ jsxs("div", {
					className: "mt-4 space-y-4",
					children: [/* @__PURE__ */ jsx("div", { className: "h-4 w-full animate-pulse rounded bg-muted" }), /* @__PURE__ */ jsx("div", { className: "h-4 w-3/4 animate-pulse rounded bg-muted" })]
				})]
			})]
		}),
		/* @__PURE__ */ jsxs("div", {
			className: "mt-6 rounded-lg border bg-card p-5",
			children: [/* @__PURE__ */ jsx("div", { className: "h-5 w-32 animate-pulse rounded bg-muted" }), /* @__PURE__ */ jsx("div", {
				className: "mt-4 space-y-3",
				children: Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ jsx("div", { className: "h-10 w-full animate-pulse rounded bg-muted" }, i))
			})]
		})
	] });
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		...
		/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("section", {
				...
				}), chartOrders.length === 0 ? /* @__PURE__ */ jsx("p", {
					className: "mt-8 text-sm text-muted-foreground",
					children: "No orders yet."
				}) : /* @__PURE__ */ jsx("div", {
					className: "mt-8 flex h-48 items-end gap-2",
					children: chartOrders.map((o, i) => /* @__PURE__ */ jsxs("div", {
				...
				}), metrics.lowStock.length === 0 ? /* @__PURE__ */ jsx("p", {
					className: "mt-4 text-sm text-muted-foreground",
					children: "All products are well-stocked."
				}) : /* @__PURE__ */ jsx("div", {
					className: "mt-4 space-y-4 text-sm",
					children: metrics.lowStock.map((p) => /* @__PURE__ */ jsxs("p", { children: [
		...
		/* @__PURE__ */ jsxs("section", {
			...
			children: [/* @__PURE__ */ jsx("h2", {
				className: "font-semibold",
				children: "Recent Orders"
			}), metrics.recentOrders.length === 0 ? /* @__PURE__ */ jsx("p", {
				className: "mt-4 text-sm text-muted-foreground",
				children: "No orders yet."
			}) : /* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("table", {
					...
					children: [/* @__PURE__ */ jsx("thead", {
					...
					}), /* @__PURE__ */ jsx("tbody", { children: metrics.recentOrders.map((o) => /* @__PURE__ */ jsxs("tr", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("td", { children: o.user.name }),
							/* @__PURE__ */ jsxs("td", { children: ["₹", Number(o.total).toLocaleString("en-IN")] }),
...
//#endregion
//#region src/routes/admin/components/ProductsSection.tsx
var emptyForm$1 = {
	name: "",
	slug: "",
	sku: "",
...
function ProductsSection({ token }) {
	...
	if (error) return /* @__PURE__ */ jsxs("section", {
		className: "rounded-lg border bg-card p-5",
		children: [
			/* @__PURE__ */ jsx("div", {
				className: "flex items-center justify-between",
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		/* @__PURE__ */ jsxs("section", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(Search, { className: "absolute left-3 top-2.5 size-4 text-muted-foreground" }), /* @__PURE__ */ jsx("input", {
						value: query,
		...
		/* @__PURE__ */ jsx(Dialog, {
			...
			children: /* @__PURE__ */ jsxs(DialogContent, {
				className: "max-w-lg",
				children: [
					/* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsx(DialogTitle, { children: editId ? "Edit product" : "Add product" }) }),
					/* @__PURE__ */ jsxs("div", {
		...
		/* @__PURE__ */ jsx(Dialog, {
			...
			children: /* @__PURE__ */ jsxs(DialogContent, {
				className: "max-w-sm",
				children: [
					/* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsx(DialogTitle, { children: "Delete product" }) }),
					/* @__PURE__ */ jsx("p", {
						className: "text-sm text-muted-foreground",
...
//#endregion
//#region src/routes/admin/components/CategoriesSection.tsx
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					!loading && !error && filtered.length === 0 && /* @__PURE__ */ jsx("p", {
						className: "text-sm text-muted-foreground",
						children: "No categories found."
					}),
					!loading && !error && filtered.map((cat) => /* @__PURE__ */ jsxs("div", {
						className: "flex flex-wrap items-center justify-between gap-3 rounded-md border p-4",
						children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
							className: "font-medium",
							children: cat.name
							...
							children: [
								/* @__PURE__ */ jsxs("span", { children: ["/", cat.slug] }),
								/* @__PURE__ */ jsx("span", { children: cat.image ? "✓ Image" : "No image" }),
								/* @__PURE__ */ jsxs("span", { children: [cat._count?.products ?? 0, " products"] })
							]
						})] }), /* @__PURE__ */ jsxs("div", {
							className: "flex gap-2",
							children: [/* @__PURE__ */ jsx("button", {
			...
			/* @__PURE__ */ jsx(Dialog, {
				...
				children: /* @__PURE__ */ jsxs(DialogContent, { children: [
					/* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsx(DialogTitle, { children: editing ? "Edit category" : "Add category" }) }),
					/* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsx(Dialog, {
				...
				children: /* @__PURE__ */ jsxs(DialogContent, { children: [
					/* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsx(DialogTitle, { children: "Delete category" }) }),
					/* @__PURE__ */ jsxs("p", {
						className: "text-sm text-muted-foreground",
						children: [
...
//#endregion
//#region src/routes/admin/components/OrdersSection.tsx
var STATUS_STYLES = {
	PENDING: "bg-amber-100 text-amber-800",
	CONFIRMED: "bg-blue-100 text-blue-800",
		...
		children: [/* @__PURE__ */ jsx(Toaster$1, {}), /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					!loading && !error && filtered.length > 0 && /* @__PURE__ */ jsx("div", {
						className: "space-y-2",
						children: filtered.map((order) => /* @__PURE__ */ jsxs("div", {
							className: "flex flex-wrap items-center justify-between gap-3 rounded-md border p-4",
							children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
								className: "font-medium",
								...
								children: [/* @__PURE__ */ jsx("span", {
									...
									children: STATUS_OPTIONS$1.map((s) => /* @__PURE__ */ jsx("option", {
										value: s,
										children: s
									}, s))
								})]
...
//#endregion
//#region src/routes/admin/components/CustomersSection.tsx
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", { className: "h-4 w-48 rounded bg-muted" }), /* @__PURE__ */ jsx("div", { className: "mt-2 h-3 w-32 rounded bg-muted" })]
					}, i))
				}) : filtered.length === 0 ? /* @__PURE__ */ jsx("p", {
					className: "text-sm text-muted-foreground",
...
//#endregion
//#region src/routes/admin/components/EnquiriesSection.tsx
var STATUS_OPTIONS = [
	"ALL",
	"NEW",
	"CONTACTED",
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					className: "space-y-2",
					children: filtered.map((enq) => /* @__PURE__ */ jsxs("div", {
						className: "flex flex-wrap items-center justify-between gap-3 rounded-md border p-4",
						children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
							className: "font-medium",
							...
							children: [
								...
								(enq.status === "NEW" || enq.status === "CONTACTED" || enq.status === "ON_HOLD") && /* @__PURE__ */ jsx("button", {
									onClick: () => handleStatus(enq.id, "APPROVED"),
									className: "text-sm text-emerald-600 hover:underline",
									children: "Approve"
								}),
								enq.status !== "REJECTED" && /* @__PURE__ */ jsx("button", {
			...
			/* @__PURE__ */ jsx(Dialog, {
				...
				children: /* @__PURE__ */ jsxs(DialogContent, {
					className: "max-w-lg",
					children: [
						/* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsxs(DialogTitle, { children: ["Notes — ", activeEnquiry?.companyName || activeEnquiry?.name] }) }),
						/* @__PURE__ */ jsx("div", {
							className: "max-h-64 overflow-y-auto space-y-2",
							children: activeEnquiry?.notes && activeEnquiry.notes.length > 0 ? activeEnquiry.notes.map((n) => /* @__PURE__ */ jsxs("div", {
								className: "rounded border p-3 text-sm",
								children: [/* @__PURE__ */ jsx("p", { children: n.body }), /* @__PURE__ */ jsx("p", {
									className: "mt-1 text-xs text-muted-foreground",
...
//#endregion
//#region src/routes/admin/components/BrandsSection.tsx
var emptyForm = {
	name: "",
	logoUrl: "",
	sortOrder: 0,
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					className: "space-y-2",
					children: filtered.map((b) => /* @__PURE__ */ jsxs("div", {
						className: "flex flex-wrap items-center justify-between gap-3 rounded-md border p-4",
						children: [/* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-3",
							children: [b.logoUrl && /* @__PURE__ */ jsx("img", {
								src: b.logoUrl,
								alt: b.name,
			...
			/* @__PURE__ */ jsx(Dialog, {
				...
				children: /* @__PURE__ */ jsxs(DialogContent, {
					className: "max-w-lg",
					children: [
						/* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsx(DialogTitle, { children: editing ? "Edit brand" : "Add brand" }) }),
						/* @__PURE__ */ jsxs("div", {
							className: "space-y-4",
							children: [
								/* @__PURE__ */ jsxs("label", {
								...
								/* @__PURE__ */ jsxs("label", {
									className: "text-sm font-medium",
									children: ["Logo URL", /* @__PURE__ */ jsx("input", {
										value: form.logoUrl,
										onChange: (e) => setForm((f) => ({
											...f,
								...
								/* @__PURE__ */ jsxs("label", {
									className: "text-sm font-medium",
									children: ["Sort order", /* @__PURE__ */ jsx("input", {
										type: "number",
...
//#endregion
//#region src/routes/admin/components/CmsSection.tsx
var BLOCK_LABELS = {
...
function CmsSection({ token }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			!loading && !error && blocks.length === 0 && /* @__PURE__ */ jsx("p", {
				className: "py-12 text-center text-sm text-muted-foreground",
				children: "No homepage blocks found."
			}),
			!loading && !error && blocks.length > 0 && /* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("table", {
					...
					children: [/* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", {
						...
						className: "divide-y",
						children: blocks.map((block) => /* @__PURE__ */ jsxs("tr", {
			...
			/* @__PURE__ */ jsx(Dialog, {
				...
				children: /* @__PURE__ */ jsxs(DialogContent, {
					className: "max-w-2xl",
					children: [
						/* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsx(DialogTitle, { children: selectedBlock?.key ? `Configure: ${BLOCK_LABELS[selectedBlock.key] || selectedBlock.key}` : "Configure block" }) }),
...
//#endregion
//#region src/routes/admin/components/MediaSection.tsx
...
function MediaSection({ token }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			!loading && !error && mediaList.length === 0 && /* @__PURE__ */ jsx("p", {
				className: "py-12 text-center text-sm text-muted-foreground",
				children: "No media files yet."
			}),
			!loading && !error && mediaList.length > 0 && /* @__PURE__ */ jsx("div", {
				className: "grid grid-cols-2 gap-4 sm:grid-cols-4",
				children: mediaList.map((media) => /* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsx(Dialog, {
				...
				children: /* @__PURE__ */ jsxs(DialogContent, { children: [
					/* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsx(DialogTitle, { children: "Edit Media" }) }),
					/* @__PURE__ */ jsxs("div", {
						className: "space-y-4",
			...
			/* @__PURE__ */ jsx(Dialog, {
				...
				children: /* @__PURE__ */ jsxs(DialogContent, { children: [
					/* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsx(DialogTitle, { children: "Delete Media" }) }),
					/* @__PURE__ */ jsxs("p", {
						className: "text-sm text-muted-foreground",
						children: [
							"Are you sure you want to delete ",
							/* @__PURE__ */ jsx("strong", { children: deleteConfirm?.filename }),
							"? This action cannot be undone."
						]
					}),
					/* @__PURE__ */ jsxs(DialogFooter, { children: [/* @__PURE__ */ jsx("button", {
...
//#endregion
//#region src/routes/admin/components/SettingsSection.tsx
var SETTINGS_FIELDS = [
	{
		key: "website_name",
		label: "Website name"
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			!loading && !error && /* @__PURE__ */ jsx("div", {
				...
				children: SETTINGS_FIELDS.map((field) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
					className: "text-sm font-medium",
...
function AdminDashboard() {
	...
	const Sidebar = () => /* @__PURE__ */ jsxs("aside", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("nav", {
				...
				children: nav.map(({ label, icon: Icon }) => /* @__PURE__ */ jsxs("button", {
					onClick: () => {
						setSection(label);
						setOpen(false);
					},
	...
	const renderSection = () => {
		switch (section) {
			case "Dashboard": return /* @__PURE__ */ jsx(DashboardSection, { token });
			case "Products": return /* @__PURE__ */ jsx(ProductsSection, { token });
			case "Categories": return /* @__PURE__ */ jsx(CategoriesSection, { token });
			case "Orders": return /* @__PURE__ */ jsx(OrdersSection, { token });
			case "Customers": return /* @__PURE__ */ jsx(CustomersSection, { token });
			case "Seller Enquiries": return /* @__PURE__ */ jsx(EnquiriesSection, { token });
			case "Collaborations": return /* @__PURE__ */ jsx(BrandsSection, { token });
			case "Homepage CMS": return /* @__PURE__ */ jsx(CmsSection, { token });
			case "Media Library": return /* @__PURE__ */ jsx(MediaSection, { token });
			case "Settings": return /* @__PURE__ */ jsx(SettingsSection, { token });
			default: return /* @__PURE__ */ jsx(DashboardSection, { token });
		}
	};
	return /* @__PURE__ */ jsxs("div", {
