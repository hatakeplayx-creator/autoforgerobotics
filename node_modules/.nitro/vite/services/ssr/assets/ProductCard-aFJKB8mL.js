import { u as useWishlist } from "./StoreFooter-DMLW-oTe.js";
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("span", {
					...
					children: /* @__PURE__ */ jsx(Heart, { className: `h-4 w-4 ${isInWishlist(product.sku) ? "fill-accent text-accent" : ""}` })
				})]
			}),
			/* @__PURE__ */ jsxs(Link, {
				to: "/shop/$sku",
				...
				children: [
					...
					product.featured && /* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ jsx(Star, { className: `h-3.5 w-3.5 text-border` }, i)), /* @__PURE__ */ jsxs("span", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [
					...
					product.compareAtPrice && product.compareAtPrice > product.price && /* @__PURE__ */ jsx("p", {
				...
				] }), !isOutOfStock && /* @__PURE__ */ jsxs("button", {
					...
					children: [/* @__PURE__ */ jsx(ShoppingCart, { className: "h-3.5 w-3.5" }), "Add to Cart"]
				})]
			})
		]
	});
