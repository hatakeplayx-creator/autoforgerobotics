import { i as apiFetch, t as useAuth } from "./useAuth-COIZ1r_K.js";
import { t as WishlistContext } from "./WishlistContext-YfAgkqnk.js";
import { n as useCart, t as formatPrice } from "./store-data-DRJwi3Ya.js";
...
import { ArrowRight, Check, ChevronDown, ChevronRight, Circle, Cog, Facebook, Heart, HelpCircle, Instagram, Linkedin, Mail, MapPin, Menu, Minus, Phone, Plus, Search, ShoppingCart, Trash, Twitter, User, X, Youtube } from "lucide-react";
import { clsx } from "clsx";
import * as DropdownMenuPrimitive from "@radix-ui/react-dropdown-menu";
//#region src/components/store/TopBar.tsx
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("span", {
						...
						children: [/* @__PURE__ */ jsx(Phone, { className: "h-3.5 w-3.5 text-primary" }), /* @__PURE__ */ jsxs("span", { children: ["Toll Free: ", /* @__PURE__ */ jsx("strong", { children: "1800 266 6123" })] })]
					}),
					/* @__PURE__ */ jsx("span", {
					...
					/* @__PURE__ */ jsxs("span", {
						className: "flex items-center gap-1.5",
						children: [/* @__PURE__ */ jsx(MapPin, { className: "h-3.5 w-3.5 text-primary" }), /* @__PURE__ */ jsx("span", { children: "Pune, Maharashtra, India" })]
					})
				]
			}), /* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("button", {
						...
						children: [/* @__PURE__ */ jsx(HelpCircle, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ jsx("span", { children: "Need Help?" })]
					}),
					/* @__PURE__ */ jsx("span", {
...
//#endregion
//#region src/hooks/useWishlist.ts
...
//#endregion
//#region src/components/store/StoreHeader.tsx
			...
			children: [
				/* @__PURE__ */ jsxs(Link, {
					...
					children: [/* @__PURE__ */ jsx("span", {
						...
						children: /* @__PURE__ */ jsx(Cog, { className: "h-5 w-5 text-accent-foreground animate-spin-slow" })
					}), /* @__PURE__ */ jsxs("span", {
				...
				/* @__PURE__ */ jsxs("form", {
					...
					children: [
						...
						/* @__PURE__ */ jsx(Search, { className: "absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" }),
						/* @__PURE__ */ jsx("button", {
							type: "submit",
							className: "sr-only",
							children: "Search"
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs(Link, {
							...
							children: [/* @__PURE__ */ jsx(Heart, { className: "h-5 w-5" }), wishlistItems.length > 0 && /* @__PURE__ */ jsx("span", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsx(ShoppingCart, { className: "h-5 w-5" }), itemCount > 0 && /* @__PURE__ */ jsx("span", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [
										/* @__PURE__ */ jsx(ShoppingCart, { className: "h-8 w-8 text-muted-foreground/60 stroke-1 mb-2" }),
										/* @__PURE__ */ jsx("p", {
									...
									children: cartItems.map((item) => /* @__PURE__ */ jsxs("div", {
										...
										children: [
											...
											/* @__PURE__ */ jsx("button", {
												...
												children: /* @__PURE__ */ jsx(Trash, { className: "h-3.5 w-3.5" })
											})
										]
									}, item.product.sku))
								}), /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx(Link, {
											...
											children: [/* @__PURE__ */ jsx("span", { children: "Checkout" }), /* @__PURE__ */ jsx(ArrowRight, { className: "h-3 w-3" })]
										})]
									})]
								})] })]
							})]
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("button", {
								...
								children: isAuthenticated ? /* @__PURE__ */ jsxs(Fragment, { children: [
									/* @__PURE__ */ jsx(Link, {
										to: "/profile",
...
//#endregion
//#region src/services/productService.ts
...
//#endregion
//#region src/hooks/useStoreData.ts
...
//#endregion
//#region src/components/store/NavBar.tsx
var navLinkToRoute = {
	Home: "/",
	Shop: "/shop",
	Forum: "/forum",
...
function NavBar() {
	...
	if (metadataLoading || !data) return /* @__PURE__ */ jsx("nav", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx(Skeleton, { className: "h-8 w-32 shrink-0" }), /* @__PURE__ */ jsx("div", {
				className: "flex items-center gap-4",
				children: Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ jsx(Skeleton, { className: "h-4 w-16 shrink-0" }, i))
			})]
		})
	});
	return /* @__PURE__ */ jsx("nav", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs(DropdownMenu, { children: [/* @__PURE__ */ jsx(DropdownMenuTrigger, {
				...
				className: "w-56",
				children: categoriesLoading ? /* @__PURE__ */ jsxs("div", {
					className: "p-2",
					children: [
				...
				children: [data.navLinks.map((link) => {
					...
					if (!to) return /* @__PURE__ */ jsxs("button", {
						type: "button",
						onClick: () => {
						...
						children: [link, (link === "Shop" || link === "Blogs") && /* @__PURE__ */ jsx(ChevronDown, { className: "ml-1 inline h-3.5 w-3.5" })]
					}, link);
...
//#endregion
//#region src/components/store/StoreFooter.tsx
...
function StoreFooter() {
	return /* @__PURE__ */ jsxs("footer", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [
				/* @__PURE__ */ jsxs(Link, {
					...
					children: [/* @__PURE__ */ jsx("span", {
						...
						children: /* @__PURE__ */ jsx(Cog, { className: "h-6 w-6 text-accent-foreground" })
					}), /* @__PURE__ */ jsxs("span", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("p", {
							className: "flex items-center gap-2",
							children: [/* @__PURE__ */ jsx(MapPin, { className: "h-4 w-4 shrink-0" }), " Pune, Maharashtra, India"]
						}),
						/* @__PURE__ */ jsxs("p", {
							className: "flex items-center gap-2",
							children: [/* @__PURE__ */ jsx(Phone, { className: "h-4 w-4 shrink-0" }), " 1800 266 6123"]
						}),
						/* @__PURE__ */ jsxs("p", {
							className: "flex items-center gap-2",
							children: [/* @__PURE__ */ jsx(Mail, { className: "h-4 w-4 shrink-0" }), " support@autoforgerobotics.in"]
						})
					]
				}),
				/* @__PURE__ */ jsxs("div", {
			...
			] }), columns.map((col) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h3", {
				className: "text-sm font-bold uppercase tracking-wide text-foreground",
				children: col.title
			}), /* @__PURE__ */ jsx("ul", {
				className: "mt-4 space-y-2.5",
				children: col.links.map((link) => {
					if (col.title === "Top Categories") return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, {
						to: "/shop",
					...
					if (!to) return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("button", {
						type: "button",
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("p", { children: "© 2026 AutoForge Robotics. All rights reserved." }), /* @__PURE__ */ jsxs("div", {
...
//#endregion
export { useHeroBanners as a, useStoreMetadata as c, AnnouncementBar as d, TopBar as f, useCategories as i, StoreHeader as l, NavBar as n, useProductDetails as o, Skeleton as r, useProducts as s, StoreFooter as t, useWishlist as u };
