...
//#region src/routes/sell-on-autoforge.tsx?tsr-split=component
var fields = [
	"Full Name",
	"Company Name",
	"Email",
					...
					/* @__PURE__ */ jsxs("form", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("label", {
								...
								children: ["Business Description", /* @__PURE__ */ jsx("textarea", {
									required: true,
									name: "description",
									rows: 4,
									className: "mt-1.5 w-full rounded-md border bg-background px-3 py-2 font-normal"
							...
							/* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "size-4" }), saving ? "Submitting…" : "Submit application"]
							})
						]
					})
				]
