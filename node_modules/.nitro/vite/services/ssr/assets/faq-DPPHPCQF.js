...
function FAQPage() {
	...
	return /* @__PURE__ */ jsx(StorePageShell, { children: /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h1", {
			...
			children: [
			...
			].map((faq, index) => /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("button", {
					...
					}), openIndex === index ? /* @__PURE__ */ jsx(ChevronUp, { className: "h-5 w-5 text-muted-foreground" }) : /* @__PURE__ */ jsx(ChevronDown, { className: "h-5 w-5 text-muted-foreground" })]
