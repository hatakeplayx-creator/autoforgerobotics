import { t as Route } from "./_sku-BUMjonOV.js";
import { d as AnnouncementBar, f as TopBar, l as StoreHeader, n as NavBar, o as useProductDetails, r as Skeleton, s as useProducts, t as StoreFooter, u as useWishlist } from "./StoreFooter-DMLW-oTe.js";
import { n as useCart, t as formatPrice } from "./store-data-DRJwi3Ya.js";
import { t as cn } from "./utils-C_uf36nf.js";
import { a as BreadcrumbPage, i as BreadcrumbList, n as BreadcrumbItem, o as BreadcrumbSeparator, r as BreadcrumbLink, t as Breadcrumb } from "./breadcrumb-BG427xXB.js";
import { t as Button } from "./button-Bq5vK6RO.js";
import { t as ProductCard } from "./ProductCard-aFJKB8mL.js";
import { useEffect, useMemo, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { toast } from "sonner";
import { AlertTriangle, CheckCircle2, Heart, MessageSquare, Minus, Plus, ShoppingCart, Star } from "lucide-react";
...
//#endregion
//#region src/routes/shop/$sku.tsx?tsr-split=component
var DEFAULT_REVIEWS = [{
	id: "r1",
	author: "Rohan Sharma",
	rating: 5,
...
function ProductDetailsPage() {
	...
	if (productLoading || productsLoading) return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("main", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						className: "space-y-4",
						children: [/* @__PURE__ */ jsx(Skeleton, { className: "aspect-square w-full rounded-lg" }), /* @__PURE__ */ jsxs("div", {
							className: "flex gap-3",
							children: [
								/* @__PURE__ */ jsx(Skeleton, { className: "h-20 w-20 rounded" }),
								/* @__PURE__ */ jsx(Skeleton, { className: "h-20 w-20 rounded" }),
								/* @__PURE__ */ jsx(Skeleton, { className: "h-20 w-20 rounded" })
							]
						})]
						...
						children: [
							...
							/* @__PURE__ */ jsx(Skeleton, { className: "h-10 w-5/6" }),
	...
	if (!product || !allProducts) return /* @__PURE__ */ jsxs("div", {
		className: "min-h-screen bg-background",
		children: [
			/* @__PURE__ */ jsx(AnnouncementBar, {}),
			/* @__PURE__ */ jsx(TopBar, {}),
		...
		children: [
			...
			/* @__PURE__ */ jsxs("main", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										/* @__PURE__ */ jsxs("p", {
											...
											children: ["SKU: ", /* @__PURE__ */ jsx("strong", {
										...
										/* @__PURE__ */ jsxs("p", {
											className: "text-muted-foreground",
											children: ["Brand: ", /* @__PURE__ */ jsx("strong", {
												className: "text-foreground",
												children: brandName
											})]
										}),
										...
										/* @__PURE__ */ jsxs("div", {
											...
											children: [Array.from({ length: 5 }).map((_, index) => /* @__PURE__ */ jsx(Star, { className: "h-3.5 w-3.5 fill-current" }, index)), /* @__PURE__ */ jsxs("span", {
								...
								/* @__PURE__ */ jsx("hr", { className: "border-border my-5" }),
								/* @__PURE__ */ jsxs("div", {
									className: "mb-4",
								...
								/* @__PURE__ */ jsx("div", {
									...
									children: product.stockQuantity <= 0 ? /* @__PURE__ */ jsxs("span", {
										...
										children: [/* @__PURE__ */ jsx(AlertTriangle, { className: "h-4 w-4" }), "Out of Stock"]
									}) : /* @__PURE__ */ jsxs("span", {
								...
								product.stockQuantity > 0 ? /* @__PURE__ */ jsxs("div", {
									className: "space-y-4",
									children: [/* @__PURE__ */ jsxs("div", {
										className: "flex items-center gap-3",
										children: [/* @__PURE__ */ jsx("span", {
										...
										children: [
											...
											/* @__PURE__ */ jsx(Button, {
												...
												className: "h-12 w-12",
												children: /* @__PURE__ */ jsx(Heart, { className: `h-5 w-5 ${isInWishlist(product.sku) ? "fill-accent text-accent" : ""}` })
											})
										]
									})]
								}) : null
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h2", {
								...
								children: [/* @__PURE__ */ jsx("p", { children: "This AutoForge component is designed as a dependable hardware platform for innovators and makers. It focuses on stability, compatibility, and practical deployment in real projects." }), /* @__PURE__ */ jsx("p", { children: "Refer to the technical specifications below before integration to verify voltage tolerance, dimensions, and interface compatibility with your setup." })]
								...
								children: /* @__PURE__ */ jsx("table", {
									...
									children: /* @__PURE__ */ jsx("tbody", { children: Object.entries(specifications).map(([key, value], index) => /* @__PURE__ */ jsxs("tr", {
							...
							children: /* @__PURE__ */ jsxs("div", { children: [
								/* @__PURE__ */ jsxs("h2", {
									...
									children: [/* @__PURE__ */ jsx(MessageSquare, { className: "h-4 w-4 text-primary" }), /* @__PURE__ */ jsxs("span", { children: [
										"Customer Reviews (",
										reviews.length,
										")"
									] })]
										...
										/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
											...
											children: Array.from({ length: 5 }).map((_, index) => {
												...
												return /* @__PURE__ */ jsx("button", {
													...
													children: /* @__PURE__ */ jsx(Star, { className: "h-4 w-4 fill-current" })
												}, ratingValue);
											})
										})] }),
										/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
										...
										children: [
											/* @__PURE__ */ jsxs("div", {
												...
												children: [/* @__PURE__ */ jsxs("h4", {
													...
													children: [/* @__PURE__ */ jsx("span", { children: review.author }), review.verified ? /* @__PURE__ */ jsx("span", {
											...
											/* @__PURE__ */ jsx("div", {
												...
												children: Array.from({ length: 5 }).map((_, index) => /* @__PURE__ */ jsx(Star, { className: `h-3 w-3 ${index < review.rating ? "fill-current" : "text-border"}` }, index))
											}),
											/* @__PURE__ */ jsx("p", {
					...
					relatedProducts.length > 0 ? /* @__PURE__ */ jsxs("section", {
						className: "mt-12",
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: relatedProducts.map((item) => /* @__PURE__ */ jsx(ProductCard, { product: item }, item.sku))
						})]
					}) : null,
					recentlyViewed.length > 0 ? /* @__PURE__ */ jsxs("section", {
						className: "mt-12",
						children: [/* @__PURE__ */ jsxs("div", {
							className: "mb-6 flex items-center gap-4",
							children: [/* @__PURE__ */ jsx("h2", {
							...
							children: recentlyViewed.map((item) => /* @__PURE__ */ jsx(ProductCard, { product: item }, item.sku))
						})]
					}) : null
				]
			}),
