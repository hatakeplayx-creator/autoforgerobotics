import { t as Route } from "./shop-BPbioZdU.js";
import { f as AnnouncementBar, i as useCategories, l as StoreHeader, n as NavBar, p as TopBar, r as Skeleton, s as useProducts, t as StoreFooter } from "./StoreFooter-Z2RR4EsA.js";
import { t as cn } from "./utils-C_uf36nf.js";
import { t as Toaster } from "./sonner-DoFKumIW.js";
...
import { t as ProductCard } from "./ProductCard-CaTb6Sc_.js";
import * as React from "react";
import { useEffect, useMemo, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { ChevronDown, ChevronLeft, ChevronRight, Filter, RotateCcw, SlidersHorizontal, X } from "lucide-react";
...
//#endregion
//#region src/routes/shop/index.tsx?tsr-split=component
...
function ShopPage() {
	...
	const [selectedBrands, setSelectedBrands] = useState(searchParams.brand ? searchParams.brand.split(",") : []);
	...
	const renderSidebarFilters = () => /* @__PURE__ */ jsxs("div", {
		className: "space-y-6",
		children: [
			/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("h3", {
				...
				children: [/* @__PURE__ */ jsx("span", { children: "Categories" }), selectedCategory && /* @__PURE__ */ jsx("button", {
					onClick: () => handleCategorySelect(""),
					className: "text-[10px] font-semibold text-primary lowercase hover:underline cursor-pointer",
					children: "Clear"
				})]
			}), categoriesLoading || !categoriesList ? /* @__PURE__ */ jsx("div", {
				className: "space-y-2 pr-1",
				children: Array.from({ length: 5 }).map((_, i) => /* @__PURE__ */ jsx(Skeleton, { className: "h-6 w-full rounded" }, i))
			}) : /* @__PURE__ */ jsx("div", {
			...
			/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h3", {
				...
				className: "space-y-2",
				children: allBrands.map((brand) => /* @__PURE__ */ jsxs("label", {
			...
			/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h3", {
				...
				className: "space-y-2",
				children: PRICE_RANGES.map((range, index) => /* @__PURE__ */ jsxs("label", {
					className: "flex items-center gap-2.5 text-xs text-muted-foreground hover:text-foreground cursor-pointer select-none",
			...
			(selectedCategory || selectedBrands.length > 0 || selectedPrices.length > 0 || inStockOnly || searchVal) && /* @__PURE__ */ jsxs("button", {
				...
				children: [/* @__PURE__ */ jsx(RotateCcw, { className: "h-3.5 w-3.5" }), "Reset All Filters"]
			})
		]
	});
				...
				children: [
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx(Breadcrumb, { children: /* @__PURE__ */ jsxs(BreadcrumbList, { children: [
							...
							/* @__PURE__ */ jsx(BreadcrumbItem, { children: /* @__PURE__ */ jsx(BreadcrumbPage, { children: "Shop" }) })
						] }) })
					}),
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h1", {
							...
							children: productsLoading ? /* @__PURE__ */ jsx("span", { children: "Filtering catalogs..." }) : /* @__PURE__ */ jsxs("span", { children: [
								"Showing ",
							...
							children: [/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsxs(Sheet, { children: [/* @__PURE__ */ jsx(SheetTrigger, {
									...
									children: /* @__PURE__ */ jsxs("button", {
										...
										children: [/* @__PURE__ */ jsx(SlidersHorizontal, { className: "h-3.5 w-3.5" }), "Filters"]
									})
									...
									children: [/* @__PURE__ */ jsx(SheetHeader, {
										...
										children: /* @__PURE__ */ jsxs(SheetTitle, {
											...
											children: [/* @__PURE__ */ jsx(Filter, { className: "h-4 w-4" }), "Filter & Sort"]
										})
								...
								children: [/* @__PURE__ */ jsx("span", {
									...
									}), /* @__PURE__ */ jsx(ChevronDown, { className: "absolute right-2.5 top-1/2 h-3.5 w-3.5 -translate-y-1/2 text-muted-foreground pointer-events-none" })]
								})]
							})]
						})]
					}),
							...
							children: productsLoading ? /* @__PURE__ */ jsx("div", {
								...
								children: Array.from({ length: 6 }).map((_, i) => /* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										/* @__PURE__ */ jsx(Skeleton, { className: "aspect-square w-full rounded" }),
										/* @__PURE__ */ jsx(Skeleton, { className: "h-4 w-3/4" }),
										/* @__PURE__ */ jsx(Skeleton, { className: "h-3 w-16" }),
										/* @__PURE__ */ jsx(Skeleton, { className: "h-7 w-full animate-pulse" })
									]
								}, i))
								...
								children: [
									/* @__PURE__ */ jsx(SlidersHorizontal, { className: "h-10 w-10 text-muted-foreground stroke-1 mb-4" }),
									/* @__PURE__ */ jsx("h3", {
								...
								className: "grid grid-cols-2 gap-4 sm:grid-cols-3 xl:grid-cols-4",
								children: paginatedProducts.map((product) => /* @__PURE__ */ jsx(ProductCard, { product }, product.sku))
