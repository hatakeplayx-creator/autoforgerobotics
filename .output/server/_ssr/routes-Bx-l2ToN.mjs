...
import { a as StoreHeader, c as useHeroBanners, d as useStoreMetadata, i as StoreFooter, n as NavBar, o as TopBar, r as Skeleton, s as useCategories, t as AnnouncementBar, u as useProducts } from "./StoreFooter-DMLW-oTe.mjs";
import { t as ProductCard } from "./ProductCard-aFJKB8mL.mjs";
import { t as useEmblaCarousel } from "../_libs/embla-carousel-react+[...].mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-Bx-l2ToN.js
...
function HeroSection() {
	...
	if (bannersLoading || metaLoading) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
	...
	if (bannersError || metadataError || !banners?.length || !meta) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		className: "mx-auto max-w-7xl px-4 py-6",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "rounded-xl border border-dashed border-border bg-card px-6 py-12 text-center",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				className: "text-xl font-bold text-foreground",
				children: "Homepage content is temporarily unavailable"
...
function CategoryGrid() {
	...
	if (error) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		className: "mx-auto max-w-7xl px-4 py-8",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "rounded-lg border border-dashed border-border bg-card px-5 py-8 text-center",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				className: "text-lg font-bold text-foreground",
				children: "Categories are temporarily unavailable"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
	...
	if (!categoriesList?.length) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		className: "mx-auto max-w-7xl px-4 py-8",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "rounded-lg border border-dashed border-border bg-card px-5 py-8 text-center",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					className: "text-lg font-bold text-foreground",
					children: "Categories are being updated"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-1 text-sm text-muted-foreground",
					children: "Browse the full catalog while new categories are added."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
					to: "/shop",
					className: "mt-4 inline-flex rounded-lg border border-primary px-4 py-2 text-sm font-semibold text-primary hover:bg-primary hover:text-primary-foreground",
			...
			children: categoriesList.map((cat) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
						...
						onError: (event) => {
							event.currentTarget.onerror = null;
							event.currentTarget.src = "/assets/cat-components.jpg";
						},
...
function FeaturedProducts() {
	...
	if (error) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				className: "text-lg font-bold text-foreground",
				children: "Featured products are temporarily unavailable"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-1 text-sm text-muted-foreground",
				children: "Please refresh the page to try again."
			})]
