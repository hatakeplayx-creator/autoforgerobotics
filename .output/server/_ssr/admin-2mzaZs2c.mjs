...
import { i as useAuth, r as apiFetch, t as ApiError } from "./useAuth-COIZ1r_K.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/admin-2mzaZs2c.js
...
function previewProductImport(rows, token) {
	return apiFetch("/api/products/import/preview", {
		method: "POST",
...
function importProducts(rows, dryRun, token) {
...
function ProductsSection({ token }) {
	...
	(0, import_react.useEffect)(() => {
		fetchCategories(token).then((response) => setCategories(response.value)).catch(() => setCategories([]));
	}, [token]);
	const openAddModal = () => {
		setEditId(null);
	...
	const handleSave = async () => {
		...
		try {
			let specifications;
			if (formData.specifications.trim()) try {
			...
			const payload = {
				...
				specifications,
				imageIds: imageIds.length ? imageIds : void 0
			};
			if (editId) {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							Object.keys(fieldErrors).length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "rounded-md border border-destructive/50 bg-destructive/10 p-3 text-sm text-destructive",
								children: Object.entries(fieldErrors).map(([field, messages]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
									field,
									": ",
									messages.join(", ")
								] }, field))
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
								className: "text-sm font-medium",
								children: ["Specifications (JSON object, optional)", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
								label: "Media IDs (comma-separated, optional)",
...
function normalize(row) {
	const parseNumber = (key) => row[key] === "" || row[key] === void 0 ? void 0 : Number(row[key]);
	const parseJson = (key) => {
		const value = row[key];
	...
	return {
		...
		lowStockThreshold: parseNumber("lowStockThreshold"),
		featured: typeof row.featured === "string" ? row.featured.toLowerCase() === "true" : row.featured,
		specifications: parseJson("specifications"),
		imageUrls
	};
}
function ProductImportSection({ token }) {
	const input = (0, import_react.useRef)(null);
	const [rows, setRows] = (0, import_react.useState)([]);
	const [preview, setPreview] = (0, import_react.useState)(null);
	const [busy, setBusy] = (0, import_react.useState)(false);
	const [result, setResult] = (0, import_react.useState)(null);
	const validRows = (0, import_react.useMemo)(() => rows.map(normalize), [rows]);
	const readFile = async (file) => {
		try {
			const text = await file.text();
			const data = file.name.toLowerCase().endsWith(".json") ? JSON.parse(text) : csvRows(text);
			const parsed = Array.isArray(data) ? data : data && typeof data === "object" && Array.isArray(data.products) ? data.products : null;
			if (!parsed || !parsed.every((row) => row && typeof row === "object")) throw new Error("Use a JSON array, a { products: [] } export, or CSV with a header row.");
			setRows(parsed);
			setPreview(null);
			setResult(null);
		} catch (error) {
	...
	const validate = async () => {
		...
		setBusy(true);
		try {
			setPreview(await previewProductImport(validRows, token));
		} catch (error) {
	...
	const submit = async (dryRun) => {
		...
		setBusy(true);
		try {
			const next = await importProducts(validRows, dryRun, token);
			setResult(next);
			toast.success(dryRun ? "Dry run completed" : `Imported ${next.created + next.updated} products`);
		} catch (error) {
	...
	const downloadTemplate = () => {
		...
		anchor.href = url;
		anchor.download = "autoforge-product-import-template.csv";
		anchor.click();
		URL.revokeObjectURL(url);
	};
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				className: "font-semibold",
				children: "Product Import"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "text-sm text-muted-foreground",
				children: "CSV, JSON, or API/database export. Products match by SKU."
			})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex gap-2",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					className: "text-sm",
					children: [rows.length, " row(s) loaded."]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							disabled: busy || !preview || preview.invalid.length > 0,
				...
				preview && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
						...
						" invalid"
					] }), preview.invalid.slice(0, 20).map((issue) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
...
function AdminDashboard() {
	...
	const renderSection = () => {
		switch (section) {
			...
			case "Product Import": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProductImportSection, { token });
