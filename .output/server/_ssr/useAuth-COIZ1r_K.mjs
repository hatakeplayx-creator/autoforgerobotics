...
//#region node_modules/.nitro/vite/services/ssr/assets/useAuth-COIZ1r_K.js
...
async function apiFetch(path, init = {}) {
	...
	if (!response.ok) {
		...
		throw new ApiError(typeof body.message === "string" ? body.message : "Request failed", response.status, fieldErrors && typeof fieldErrors === "object" ? fieldErrors : {});
	}
...
//#endregion
export { useAuth as i, AuthProvider as n, apiFetch as r, ApiError as t };
